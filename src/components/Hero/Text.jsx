  ...
  return (
    <>
      <motion.div
        ...
        className="sm:max-w-lg sm:px-0 px-3 flex flex-col items-center sm:gap-4 gap-2 sm:py-0 py-10"
      >
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-6xl">
         <span className="text-[#f4ab29] sm:text-7xl text-4xl">Summer</span>  styles are finally here
        </h1>
        <p className="mt-2 sm:text-xl text-sm text-gray-500 text-justify">
          ...
          selection with a personal touch<span className="text-[#f4ab29]">.</span>
        </p>
